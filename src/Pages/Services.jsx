...
//       <div 
//         name="services"
//         className="px-4 mb-14  py-[30px] sm:py-[10px] min-h-screen font bg-white "
//       >
//         <div  className="px-4 mb-[36px]  mt-8">
//           <h1 data-aos="fade-right" className="text-2xl md:text-4xl tracking-tight uppercase font-semibold relative inline-block align-top z-10 mb-[10px] py-[10px] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-[#d9832e] after:w-[50px] ">
...
//           {data.map((item) => (
//             <div className="group">
//               <div data-aos="flip-left" className=" bg-[#EAEDF2]  shadow-xl w-full px-[30px] py-[40px] hover:-translate-y-4 transition-all duration-[400ms] hover:rounded-md group-hover:bg-[#DB8B3B] group-hover:text-white">
